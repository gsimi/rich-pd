...
ClassImp(myRooPoisson) 



//_____________________________________________________________________________
myRooPoisson::myRooPoisson(const char *name, const char *title, 
		       RooAbsReal& _x,
		       RooAbsReal& _x0,
		       RooAbsReal& _sigma,
		       RooAbsReal& _mean,
...
//_____________________________________________________________________________
 myRooPoisson::myRooPoisson(const myRooPoisson& other, const char* name) :  
...
//_____________________________________________________________________________
Double_t myRooPoisson::evaluate() const 
{ 
...
//_____________________________________________________________________________
Int_t myRooPoisson::getAnalyticalIntegral(RooArgSet& allVars, RooArgSet& analVars, const char* /*rangeName*/) const 
{
...
//_____________________________________________________________________________
Double_t myRooPoisson::analyticalIntegral(Int_t code, const char* rangeName) const 
{
  assert(code==1) ;
...
//_____________________________________________________________________________
Int_t myRooPoisson::getGenerator(const RooArgSet& directVars, RooArgSet &generateVars, Bool_t /*staticInitOK*/) const
{
...
//_____________________________________________________________________________
void myRooPoisson::generateEvent(Int_t code)
{
